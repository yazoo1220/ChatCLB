...
st.set_page_config(page_title="ChatCLB", page_icon=":robot:")
st.header("🗓️ ChatCLB")
...
if ask_button:
    with st.spinner('typing...'):
        ...
        st.session_state.generated.append(qa.predict(user_input)['answer']) #({"question": user_input, "chat_history": chat_history})['answer'])
#         user_input.value = ""
